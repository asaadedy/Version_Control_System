...
#define SENDFILE 1
#define ERROR 2
// maximum connections to clients
...
struct request {
	int soc;			//socket
	int step;			// proccess step in wich the server need to continue from
...
int trace_send(char *source, int soc, char *host, unsigned short port);
